import { users, type User, type InsertUser, foodItems, type FoodItem, type InsertFoodItem, orders, type Order, type InsertOrder } from "@shared/schema";
...
export class MemStorage implements IStorage {
  ...
  private async seedFoodItems() {
    ...
    await this.createFoodItem({
      ...
      price: 80,
      imageUrl: "https://images.unsplash.com/photo-1630383249896-483b1fbeb2fa",
      category: "south-indian",
      isAvailable: true,
      isVegetarian: true,
    });
    ...
    await this.createFoodItem({
      name: "Vada",
      description: "Crispy fried doughnut shaped lentil fritters served with sambar and chutney.",
      price: 60,
    ...
    await this.createFoodItem({
      name: "Sambhar Rice",
      description: "Steamed rice mixed with lentil-based vegetable stew seasoned with spices.",
      price: 150,
    ...
    await this.createFoodItem({
      ...
      description: "Cottage cheese cubes in rich tomato and butter gravy with aromatic spices.",
      price: 180,
    ...
    await this.createFoodItem({
      name: "Chole Bhature",
      description: "Spicy chickpea curry served with fried bread, onions and pickle.",
      price: 150,
    ...
    await this.createFoodItem({
      ...
      description: "Stir-fried noodles with mixed vegetables and aromatic Indo-Chinese sauces.",
      price: 140,
    ...
    await this.createFoodItem({
      name: "Veg Manchurian",
      description: "Vegetable dumplings tossed in a spicy, sweet and tangy sauce.",
      price: 160,
    ...
    await this.createFoodItem({
      ...
      description: "Crispy rolls filled with shredded vegetables and served with dipping sauce.",
      price: 120,
    ...
    await this.createFoodItem({
      name: "Chilli Paneer",
      description: "Cottage cheese cubes tossed with bell peppers in spicy sauce.",
      price: 170,
