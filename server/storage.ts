...
export class MemStorage implements IStorage {
  ...
  private async seedFoodItems() {
    ...
    await this.createFoodItem({
      ...
      price: 120,
      imageUrl:
        "https://media.istockphoto.com/id/942682776/photo/masala-dosa-indian-breakfast-crepes-with-spicy-potato-filling.webp?a=1&b=1&s=612x612&w=0&k=20&c=LM5nGfClVFYZDlyqqvUCahI6CJ1vN4DuggMIsbcYlBo=",
